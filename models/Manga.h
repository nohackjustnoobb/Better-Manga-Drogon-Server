...
class Manga
{
  public:
     ...
     */
    explicit Manga(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<Manga>;
    friend drogon::orm::BaseBuilder<Manga, true, true>;
    friend drogon::orm::BaseBuilder<Manga, true, false>;
    friend drogon::orm::BaseBuilder<Manga, false, true>;
    friend drogon::orm::BaseBuilder<Manga, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Manga>;
#endif
